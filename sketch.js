...
let colors = ['green','red', 'magenta', 'white','violet']; //untuk pieplot
let url = 'https://docs.google.com/spreadsheets/d/e/2PACX-1vSzAERid9P4X2zifN0njqEXiH2MznFmh7OfLzbYGA_TcBVrKJIxxh6vaFSgoWSm5u4H4TnhUxWEJsAV/pub?output=csv';
